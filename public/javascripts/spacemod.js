...
(function () {
	...
	var ScrollController = function () {
		...
		var repeatOnScroll = function (func1, func2, interv) {
			method1 = func1;
			method2 = func2;
			interval = interv;
	...
	var SpaceController = function () {
		...
		var init = function () {
			...
			scrollControl.repeatOnScroll(animate, setVolume, 1000/60);
		};
		...
		var setVolume  = function () {
			var hiddenFrames = $(".space-frame").filter(function() { return $(this).css("display") == "none" });
